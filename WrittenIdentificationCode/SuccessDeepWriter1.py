...
import pickle
img_files_in = open('img_files1.dat', 'rb')
encoded_Y_in = open('encoded_Y1.dat', 'rb')
...
train_dataset_in = open('/content/drive/My Drive/Dataset/train_dataset.dat', 'rb')


train_dataset= pickle.load(train_dataset_in)


train_dataset_in.close()
...
the_model = DeepWriter(*args, **kwargs)
